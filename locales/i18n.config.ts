export default defineI18nConfig(() => ({
  ...
  messages: {
    pl: {
      ...
      komputronik:
        'Praca w firmie zajmującej się digital signage oraz tworzeniem dedykowanych aplikacji webowych na zlecenie klientów.<br><br>Byłem odpowiedzialny za:<br><br><ul><li>Tworzenie aplikacji frontendowych (Vue.js + TypeScript)</li><li>Rozwój i utrzymanie wewnętrznych systemów</li><li>Poprawę wydajności i jakość kodu</li><li>Naprawianie błędów w istniejących aplikacjach.</li></ul><br>Realizowałem projekty dla wielu zewnętrznych klientów, uczestniczyłem w procesie wyceny oraz planowania zadań. Pracowałem w zespole scrumowym, wykorzystując narzędzia takie jak JIRA. Na co dzień ściśle współpracowałem z zespołem backendowym, dbając o efektywną integrację z API oraz spójność rozwiązań frontendowych.',
      now: 'obecnie',
      self_employed:
        'Opracowywanie i utrzymywanie aplikacji webowych oraz stron internetowych przy użyciu nowoczesnych technologii: Vue.js, JavaScript, HTML, Node.js, SQL, Vite, Webpack. Aktywnie biore udział w procesach CI/CD oraz konfiguracjach serwerowych.<br><br>Jestem odpowiedzialny za:<br><br><ul><li>Tworzenie aplikacji webowych (Vue.js + TypeScript)</li><li>Rozwój i utrzymanie wewnętrznych systemów</li><li>Poprawę wydajności i jakość kodu</li><li>Naprawianie błędów w istniejących aplikacjach.</li><li>Współpracy z wewnętrznym zespołem klienta.</li></ul><br>Realizuję rozwiązania usprawniające działanie aplikacji zarówno od strony użytkownika, jak i pod kątem technicznym.',
    ...
    en: {
      about_me: 'About me',
      about_me_description:
        "I'm a frontend developer with commercial experience since April 2017. I've worked at three different companies, where I was responsible for developing modern, responsive, and high-performance web applications. My focus is on clean code, scalable architecture, and delivering intuitive user interfaces.",
      about_me_description2:
